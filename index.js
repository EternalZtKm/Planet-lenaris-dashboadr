...
const REDIRECT_URI = process.env.REDIRECT_URI || "https://planet-lenaris-roleplay.onrender.com/api/auth/discord/callback";
...
async function checkCommsAndRunReminders() {
    ...
    try {
        ...
        for (const p of livePlayers) {
            ...
            if (!foundInComms) {
                const pmMsg = `:pm ${rawName} We have detected that your not in the mandatory comms. Call !mod and tell them you have received this pm.`;
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            console.log('\n======================================================');
            console.log(`🌐 [NETWORK] Your Server Public IP is: ${data.ip}`);
